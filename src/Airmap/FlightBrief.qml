    ...
    Column {
        ...
        Row {
            ...
            QGCButton {
                ...
                heightFactor:   0.3333
                showBorder:     true
                //enabled:        _flightPermit === AirspaceFlightPlanProvider.PermitAccepted || _flightPermit === AirspaceFlightPlanProvider.PermitNotRequired || _flightPermit === AirspaceFlightPlanProvider.PermitManualAuthorization
                width:          ScreenTools.defaultFontPixelWidth * 12
                visible:        planView
                onClicked: {
