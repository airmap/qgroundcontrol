...
public:
  ...
  //  return QUrl::fromUserInput("qrc:/custom/CustomFlyView.qml");
  //}
  // QUrl mapOverlay() const final {
  //  return QUrl::fromUserInput("qrc:/custom/MapGrid.qml");
  //}
  QUrl preFlightChecklistUrl() const final {
    return QUrl::fromUserInput("qrc:/custom/PreFlightCheckList.qml");
  }
  //-- We have our own toolbar
  // QUrl mainToolbarUrl() const final {
  //  return QUrl::fromUserInput("qrc:/custom/CustomMainToolBar.qml");
  //}
  // QUrl planToolbarUrl() const final {
  //  return QUrl::fromUserInput("qrc:/custom/CustomMainToolBar.qml");
  //}
  ...
  // TODO: Can't access QGCPalette without some workarounds, change this
  // upstream
...
public:
  ...
  VideoManager *createVideoManager(QGCApplication *app,
                                   QGCToolbox *toolbox) final;
  ...
  void paletteOverride(QString colorName,
...
private:
  ...
  QVariantList _customSettingsList; // Not to be mixed up with QGCCorePlugin
                                    // implementation
};
